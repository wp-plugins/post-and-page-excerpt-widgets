...
class PageExcerptMulti extends WP_Widget {
	...
	function widget( $args, $instance ) {
			...
			if (function_exists('the_excerpt_reloaded')) 
				...
				echo '<p class="more" title="'.$title.'"><a href="'.get_permalink($instance['page_ID']).'">'.$instance['more_text'].'</a></p>'; // 'more' link
			}
			endwhile;
			?>
			</ul>
...
class PostExcerptMulti extends WP_Widget {
	...
	function widget( $args, $instance ) {
			...
			if (function_exists('the_excerpt_reloaded')) 
				...
				the_excerpt();  // this covers Advanced Excerpt as well as the built-in one
				echo '<p class="more" title="'.$title.'"><a href="'.get_permalink($instance['post_ID']).'">'.$instance['more_text'].'</a></p>'; // 'more' link
			}
			endwhile;
			?>
			</ul>
